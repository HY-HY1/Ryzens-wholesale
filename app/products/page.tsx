...
import Forklift from '@/public/forklift.jpg'
    ...
    <div className='w-[70vw] m-auto'>
      <div className='w-full grid grid-cols-2 gap-40 my-10'>
        <div className='rounded-md shado-sm'>
          <img src={Forklift.src} className='rounded-xl brightness-50 max-w-[400px min-h-[400px] object-cover shadow-sm ' alt="Stock" />
        </div>
